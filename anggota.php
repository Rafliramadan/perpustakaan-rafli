...
<table class="table table-striped table-hover">
    ...
    <?php
        $querybaru = mysqli_query($konek,"SELECT anggota.nis, anggota.nama, anggota.jk, anggota.tempat_lahir, anggota.tanggal_lahir, anggota.kelas, anggota.jurusan, anggota.alamat")
